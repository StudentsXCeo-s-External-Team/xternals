...
export default function Footer() {
  return (
    <footer className="w-full bg-sxc-navy text-white">
      <div className="mx-auto max-w-screen-2xl px-6 sm:px-8 lg:px-12 py-12 sm:py-16">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div>
            <Link href="/" className="inline-block">
              <div className="leading-tight">
                ...
                <div className="text-xs font-semibold tracking-wider text-sxc-skyblue">Jakarta</div>
              </div>
            </Link>
          ...
          <div>
            ...
            <ul className="mt-3 space-y-2 text-sm text-white/70">
              <li><Link href="/about" className="hover:text-sxc-skyblue transition-colors">Know About Us</Link></li>
              <li><Link href="/our-people" className="hover:text-sxc-skyblue transition-colors">Our People</Link></li>
              <li><Link href="/alumni-network" className="hover:text-sxc-skyblue transition-colors">Alumni Network</Link></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="mt-3 space-y-2 text-sm text-white/70">
              <li><Link href="/programs" className="hover:text-sxc-skyblue transition-colors">Programs</Link></li>
              <li><Link href="/events" className="hover:text-sxc-skyblue transition-colors">Events</Link></li>
              <li><Link href="/resources" className="hover:text-sxc-skyblue transition-colors">Resources</Link></li>
              <li><Link href="/partners" className="hover:text-sxc-skyblue transition-colors">Partners</Link></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="mt-3 space-y-2 text-sm text-white/70">
              <li><Link href="/join-us/community" className="hover:text-sxc-skyblue transition-colors">Join Us</Link></li>
              <li><Link href="/contact" className="hover:text-sxc-skyblue transition-colors">Contact</Link></li>
            </ul>
        ...
        <div className="mt-10 border-t border-white/10 pt-6 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-6 text-xs text-white/60">
            <a href="#" className="hover:text-sxc-skyblue transition-colors">Privacy</a>
            <a href="#" className="hover:text-sxc-skyblue transition-colors">Terms</a>
            <a href="#" className="hover:text-sxc-skyblue transition-colors">Cookies</a>
          </div>
        </div>
      </div>
    </footer>
